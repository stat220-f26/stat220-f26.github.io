...
- Due at 10pm (aligns with Skills Center hours)
...
-   Follow the "Individual Assignment" directions at <https://stat220-f26.github.io/computing/git-stat220.html> to access your `day02` repo and create an R project
-   Edit the .qmd file:
...
- Never accepted GitHub invite  &rarr; Look for it in your email and accept it or try visiting <github.com/stat220-f26> while logged in
...
``` yaml
data: "https://raw.githubusercontent.com/stat220-f26/stat220-f26.github.io/refs/heads/main/data/lego_subset.csv"
