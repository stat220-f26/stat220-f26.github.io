...
```{r}
desserts <- read_csv("../../data/desserts.csv") # https://stat220-f26.github.io/data/desserts.csv
desserts
```
...
1. Use `read_csv()` to import the `desserts` data set from <br>
 https://stat220-f26.github.io/data/desserts.csv
...
```{r}
desserts <- read_csv(
  "../../data/desserts.csv", # https://stat220-f26.github.io/data/desserts.csv
  col_types = list(
