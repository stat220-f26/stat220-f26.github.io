...
```{r}
load("../data/combining-data-examples.Rda") # https://stat220-f26.github.io/data/combining-data-examples.Rda
```
...
```{r}
messy_ratings2 <- read_csv("../data/messy_ratings2.csv") # https://stat220-f26.github.io/data/messy_ratings2.csv
messy_ratings2
```
...
```{r}
messy_ratings2b <- read_csv("../data/messy_ratings2_9_14.csv") # https://stat220-f26.github.io/data/messy_ratings2_9_14.csv
messy_ratings2b
```
...
```{r}
episodes = read_csv("../data/bakeoff-episodes.csv") # https://stat220-f26.github.io/data/bakeoff-episodes.csv
episodes
```
