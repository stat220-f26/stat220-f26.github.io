...
::: boxed-text
+-----------+--------------------------------------------------------+-----------+
| Meetings  | MWF 2a                                                 | CMC 306   |
|           |                                                        |           |
|           | 9:50-11am MW \| 9:40-10:40 F                           |           |
+-----------+--------------------------------------------------------+-----------+
...
|           | Or by appointment!                                     |           |
+-----------+--------------------------------------------------------+-----------+
| Website   | github.com/stat220-f26                                 |           |
+-----------+--------------------------------------------------------+-----------+
...
There will be three course meetings per week (Mondays, Wednesdays, and Fridays). Daily attendance and active participation is expected. Course meetings will combine demonstrations/lecture and in-class group exercises. On most days, I’ll ask you to complete a reading or watch a short video before class. You'll also have a "data science journal" that we'll spend time completing at the beginning or end of each class.
...
Portfolio project require you to integrate several smaller computational tasks and require clear communication of the proposed solution or findings to a broader audience. You will typically work in pairs.
...
Assignments and slides will be shared publicly on our course website. Grades will be posted on gradescope or Moodle. Please use our Ed discussion board for any homework or course content questions; email me privately with any personal matters (grade discussions, illness, emergency, etc.). Any time-sensitive announcements will be sent via Ed. It is your responsibility to make sure that your notification settings allow time-sensitive announcements to reach you.
...
*Example:* Ben finishes the course with 82% of homework problems successfully completed, 85% of lab quiz problems successfully completed, 1/3 portfolio projects marked "excellent", and a "Successful" final project. Ben satisfies everything in the "B" row and earns a "B" in the course.
...
I expect daily attendance and active participation. Missing \>5 class meetings or ongoing, consistent issues with being on-task will result in a 1/3 grade deduction. I'll use your data science journal as one measure of engagement: consistent, good-faith entries count toward participation, and a pattern of low-effort or empty entries will factor into the 1/3 deduction in the same way absences do.
...
-   You do not have to do everything. If you want an "A" in the class, for example, you don't have to complete *every* homework problem correctly, only 85% of them.

## What if I miss an in-person quiz?

If you need to miss a quiz due to a planned conflict, please make arrangements with me at least a week in advance. If you must miss a lab quiz due to an illness or last-minute emergency, you must notify me in advance of the quiz to arrange an alternative time. If you do not notify me in advance, you will earn 0/10 points on the in-class portion, but can still use a token to complete a revision.

## Tokens

-   Turning in a token provides either (a) a 72-hour extension on a homework assignment, (b) a revision on a portfolio project, or (c) a retake of a quiz
...
**MATH/STATS SKILLS CENTER:** The MSSC (CMC 331) offers drop-in help R/RStudio help sessions run by friendly and knowledgeable peer tutors Sunday-Thursday from 7-10pm.

**TUTORS:** If you find you need more support than office hours and the MSSC can provide, the Academic Support Center offers peer tutoring on the basis of referrals, requests, and availability of tutors. You can request tutoring through a form on their website, or discuss your needs with me and I can submit a referral.
